export default function SecuritySection() {
  return (
    <section id="security" className="max-w-6xl mx-auto px-4 py-16 md:py-24">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="flex items-start">
          <div className="bg-accent-yellow/20 border-l-4 border-accent-yellow rounded-lg p-6">
            <h3 className="font-semibold text-text-main mb-2">Human oversight built-in</h3>
            <p className="text-sm text-text-muted leading-relaxed">
              Sentinel is an internal tool for auditors and compliance teams. Humans always remain in control and responsible for final decisions. Our AI assists by surfacing potential issues, but every finding requires professional judgment and verification.
            </p>
          </div>
        </div>
      </div>
